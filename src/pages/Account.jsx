...
import { getCurrentUser, getUserBookings, getUserAdoptions, cancelUserBooking, logoutUser } from '../utils/storage';
...
export default function Account() {
  ...
  useEffect(() => {
    ...
    setAdoptions(getUserAdoptions(currentUser.email));
  }, [navigate]);
  ...
  const confirmCancellation = () => {
    ...
    cancelUserBooking(showCancelConfirm);
              ...
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 relative overflow-hidden group">
                ...
                <div className="text-center relative z-10">
                  ...
                  <button
                    ...
                    className="w-full mt-8 px-4 py-2 bg-gray-100 text-gray-700 font-bold rounded-full hover:bg-red-50 hover:text-red-600 transition duration-300 text-sm"
                  >
                          ...
                          >
                            <div>
                              <div className="flex flex-wrap items-center gap-2 mb-2">
                                ...
                                <span className="text-xs text-gray-400 font-semibold">{booking.createdAt}</span>
                              </div>
                          ...
                          >
                            <div>
                              <div className="flex flex-wrap items-center gap-2 mb-2">
                                ...
                                <span className="text-xs text-gray-400 font-semibold">{adoption.createdAt}</span>
                              </div>
                              <h4 className="text-lg font-bold font-quicksand text-dark mb-1">
