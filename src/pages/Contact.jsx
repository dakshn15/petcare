          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 gap-5">
            ...
            <div className="bg-white rounded-2xl xl:p-8 lg:p-6 p-4 shadow-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  168/170, Avenue 01,<br />Mirpur DOHS, India
                </p>
                <a
            ...
            <div className="bg-white rounded-2xl xl:p-8 lg:p-6 p-4 shadow-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <a href="tel:+8801701111000" className="text-primary hover:underline text-xl font-bold block mb-4">
                  +880 170 1111 000
                </a>
            ...
            <div className="bg-white rounded-2xl xl:p-8 lg:p-6 p-4 shadow-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <a href="mailto:info@support.com" className="text-primary hover:underline text-xl font-bold block mb-5">
                  info@support.com
                </a>
